...
public class Examples {
    ...
    private void demonstrateTreeOperation(IndexWord word) throws JWNLException {
        ...
        //System.out.println(hyponyms.getRootNode().toString());
        List<Word> words = hyponyms.getRootNode().getSynset().getWords();
        Iterator it = words.iterator();
        while(it.hasNext()){
            Word w = (Word) it.next(); 
            System.out.println(w.getLemma());
        }
        //System.out.println(hyponyms.getRootNode().getSynset().getWords());
        //hyponyms.print();
    }
